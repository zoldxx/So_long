...
/*   Updated: 2023/03/14 16:40:23 by dberreby         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_right(t_game *game, int x, int y)
{
	...
	else if (game->map[game->x_perso][game->y_perso + 1] == 'B')
		ft_exit(game);
	position_perso(&game);
}
...
void	move_down(t_game *game, int x, int y)
{
	...
	else if (game->map[game->x_perso + 1][game->y_perso] == 'B')
		ft_exit(game);
	position_perso(&game);
}
